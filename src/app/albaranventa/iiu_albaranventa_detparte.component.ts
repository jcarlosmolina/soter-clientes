...
export class AlbaranVentaIIUuAlbaranVentauDetParteComponent extends AbstractIIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016564UIInst_2';
        this.className = ModelConstants.Albaranventa.name;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_AlbaranVenta_iiu_IIU_AlbaranVenta_DetParte',
            'Albarán');
