...
import { AlbaranVentaFilterFuAlbaranVenta} from './filters/albaranventafilterfualbaranventa';
...
@Component({
    selector: 'imes-albaranventa-piu-albaranventa',
    templateUrl: './piu_albaranventa.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class AlbaranVentaPIUuAlbaranVentaComponent extends AbstractPIU implements OnInit {
    ...
    /** Filters */
    public f0: AlbaranVentaFilterFuAlbaranVenta;
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016564UIPobCl_1';
        this.className = ModelConstants.Albaranventa.name;
        this.iuName = ModelConstants.Albaranventa.piuualbaranventa;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_AlbaranVenta_piu_PIU_AlbaranVenta',
            'Albaranes');
        this.f0 = new AlbaranVentaFilterFuAlbaranVenta(this.appGlobalInfo,
