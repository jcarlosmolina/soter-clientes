...
export class AlbaranVentaPIUuAlbaranVentauDuCuotaComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016564UIPobCl_4';
        this.className = ModelConstants.Albaranventa.name;
        this.iuName = 'PIU_AlbaranVenta_D_Cuota';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_AlbaranVenta_piu_PIU_AlbaranVenta_D_Cuota',
            'Albaranes');
