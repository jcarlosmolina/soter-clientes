...
export class CheckListOTPIUuCheckListOTuMuPartePortalCComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016855UIPobCl_6';
        this.className = ModelConstants.Checklistot.name;
        this.iuName = 'PIU_CheckListOT_M_PartePortalC';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_CheckListOT_piu_PIU_CheckListOT_M_PartePortalC',
            'Check list');
