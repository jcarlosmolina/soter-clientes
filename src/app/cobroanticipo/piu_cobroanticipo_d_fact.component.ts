...
export class CobroAnticipoPIUuCobroAnticipouDuFactComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016875UIPobCl_1';
        this.className = ModelConstants.Cobroanticipo.name;
        this.iuName = 'PIU_CobroAnticipo_D_Fact';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_CobroAnticipo_piu_PIU_CobroAnticipo_D_Fact',
            'Cobros / Anticipos');
