...
export class ComprobacionOTPIUuComprobacionOTuMuParteComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016031UIPobCl_1';
        this.className = ModelConstants.Comprobacionot.name;
        this.iuName = 'PIU_ComprobacionOT_M_Parte';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_ComprobacionOT_piu_PIU_ComprobacionOT_M_Parte',
            'Comprobaciones');
