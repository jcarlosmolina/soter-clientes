...
@Component({
    selector: 'imes-contacto-piu-sistema',
    templateUrl: './piu_sistema.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ContactoPIUuSistemaComponent extends AbstractPIU implements OnInit {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016154UIPobCl_1';
        this.className = ModelConstants.Contacto.name;
        this.iuName = ModelConstants.Contacto.piuusistema;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Contacto_piu_PIU_Sistema',
            'Contactos');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016154AccOfer_1ElemAcc_1';
        accItem.alias = this.langMng.translateText(
            'cls_Contacto_act_A_Sistema_item_Clas_1699352150016154AccOfer_1ElemAcc_1',
            'Alta');
        ...
        accItem.targetUI = ModelConstants.Contacto.siuutcrear4sistema;
        accItem.setShowInModalProperties('imes-contacto-siu-tcrear4sistema',
            this.langMng.translateText(
            'cls_Contacto_svc_TCREAR4SISTEMA',
            'Alta'));
        ...
        accItem = new AccNavItem();
        accItem.id = 1;
        accItem.idXML = 'Clas_1699352150016154AccOfer_1ElemAcc_2';
        accItem.alias = this.langMng.translateText(
            'cls_Contacto_act_A_Sistema_item_Clas_1699352150016154AccOfer_1ElemAcc_2',
            'Modificar');
        ...
        accItem = new AccNavItem();
        accItem.id = 2;
        accItem.idXML = 'Clas_1699352150016154AccOfer_1ElemAcc_3';
        accItem.alias = this.langMng.translateText(
            'cls_Contacto_act_A_Sistema_item_Clas_1699352150016154AccOfer_1ElemAcc_3',
            'Eliminar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
