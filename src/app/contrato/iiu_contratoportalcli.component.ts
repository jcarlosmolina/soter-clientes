...
export class ContratoIIUuContratoPortalCliComponent extends AbstractIIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016715UIInst_3';
        this.className = ModelConstants.Contrato.name;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Contrato_iiu_IIU_ContratoPortalCli',
            'Contrato');
