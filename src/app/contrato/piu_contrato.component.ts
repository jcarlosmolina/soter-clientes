...
import { ContratoFilterFPuContrato} from './filters/contratofilterfpucontrato';
...
@Component({
    selector: 'imes-contrato-piu-contrato',
    templateUrl: './piu_contrato.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ContratoPIUuContratoComponent extends AbstractPIU implements OnInit {
    ...
    /** Filters */
    public f0: ContratoFilterFPuContrato;
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016715UIPobCl_1';
        this.className = ModelConstants.Contrato.name;
        this.iuName = ModelConstants.Contrato.piuucontrato;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Contrato_piu_PIU_Contrato',
            'Contratos');
        this.f0 = new ContratoFilterFPuContrato(this.appGlobalInfo,
