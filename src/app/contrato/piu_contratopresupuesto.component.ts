...
export class ContratoPIUuContratoPresupuestoComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016715UIPobCl_5';
        this.className = ModelConstants.Contrato.name;
        this.iuName = 'PIU_ContratoPresupuesto';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Contrato_piu_PIU_ContratoPresupuesto',
            'Contratos');
