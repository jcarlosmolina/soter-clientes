...
@Component({
    selector: 'imes-cuota-piu-cuotacontrato',
    templateUrl: './piu_cuotacontrato.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class CuotaPIUuCuotaContratoComponent extends AbstractPIU implements OnInit {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016398UIPobCl_1';
        this.className = ModelConstants.Cuota.name;
        this.iuName = ModelConstants.Cuota.piuucuotacontrato;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Cuota_piu_PIU_CuotaContrato',
            'Cuotas');
    ...
    public initializeActions(): void {
        ...
        accItem.showInDefault = false;
        accItem.styleClass = 'accMDIUGrid';
