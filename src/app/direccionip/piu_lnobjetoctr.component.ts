...
export class DireccionIPPIUuLnObjetoCtrComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016600UIPobCl_3';
        this.className = ModelConstants.Direccionip.name;
        this.iuName = 'PIU_LnObjetoCtr';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_DireccionIP_piu_PIU_LnObjetoCtr',
            'Direcciones IP');
