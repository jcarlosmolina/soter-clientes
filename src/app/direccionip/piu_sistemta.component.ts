...
export class DireccionIPPIUuSistemtaComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016600UIPobCl_1';
        this.className = ModelConstants.Direccionip.name;
        this.iuName = 'PIU_Sistemta';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_DireccionIP_piu_PIU_Sistemta',
            'Direcciones IP');
