...
export class DocumentoPIUuAlbaranPortalCliComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016172UIPobCl_28';
        this.className = ModelConstants.Documento.name;
        this.iuName = 'PIU_AlbaranPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Documento_piu_PIU_AlbaranPortalCli',
            'Documentos');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016172AccOfer_27ElemAcc_1';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_AlbaranPortalCli_item_Clas_1699352150016172AccOfer_27ElemAcc_1',
            'Previsualizar');
        ...
        accItem = new AccNavItem();
        accItem.id = 1;
        accItem.idXML = 'Clas_1699352150016172AccOfer_27ElemAcc_2';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_AlbaranPortalCli_item_Clas_1699352150016172AccOfer_27ElemAcc_2',
            'Descargar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
