...
export class DocumentoPIUuClientesComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016172UIPobCl_11';
        this.className = ModelConstants.Documento.name;
        this.iuName = 'PIU_Clientes';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Documento_piu_PIU_Clientes',
            'Documentos');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016172AccOfer_10ElemAcc_1';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Cliente_item_Clas_1699352150016172AccOfer_10ElemAcc_1',
            'Alta');
        ...
        accItem = new AccNavItem();
        accItem.id = 1;
        accItem.idXML = 'Clas_1699352150016172AccOfer_10ElemAcc_2';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Cliente_item_Clas_1699352150016172AccOfer_10ElemAcc_2',
            'Modificar notas');
        ...
        accItem = new AccNavItem();
        accItem.id = 2;
        accItem.idXML = 'Clas_1699352150016172AccOfer_10ElemAcc_4';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Cliente_item_Clas_1699352150016172AccOfer_10ElemAcc_4',
            'Previsualizar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
        ...
        accItem = new AccNavItem();
        accItem.id = 3;
        accItem.idXML = 'Clas_1699352150016172AccOfer_10ElemAcc_5';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Cliente_item_Clas_1699352150016172AccOfer_10ElemAcc_5',
            'Descargar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
    ...
    public initializeNavigations(): void {
        ...
        navItem.id = 0;
        navItem.idXML = 'Clas_1699352150016172NavOfer_3ElemNav_1';
        navItem.alias = this.langMng.translateText(
            'cls_Documento_nav_N_DocumentoCliente_item_Clas_1699352150016172NavOfer_3ElemNav_1',
