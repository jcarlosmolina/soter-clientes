...
import { DocumentoFilterFuDocumentoPortalCli} from './filters/documentofilterfudocumentoportalcli';
...
export class DocumentoPIUuClientesPortalCliComponent extends AbstractPIU {
    /** Constants for display set item aliases */
    private readonly dsnombredocumento = 'Nombre';
    private readonly dsnotas = 'Notas';

    /** Filters */
    public f0: DocumentoFilterFuDocumentoPortalCli;
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016172UIPobCl_23';
        this.className = ModelConstants.Documento.name;
        this.iuName = 'PIU_ClientesPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Documento_piu_PIU_ClientesPortalCli',
            'Documentos');
        this.f0 = new DocumentoFilterFuDocumentoPortalCli(this.appGlobalInfo,
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016172AccOfer_22ElemAcc_1';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ClientePortalCli_item_Clas_1699352150016172AccOfer_22ElemAcc_1',
            'Alta');
        ...
        accItem.targetUI = ModelConstants.Documento.siuutcrear4cliente;
        accItem.setShowInModalProperties('imes-documento-siu-tcrear4cliente',
            this.langMng.translateText(
            'cls_Documento_svc_TCREAR4CLIENTE',
            'Alta'));
        ...
        accItem = new AccNavItem();
        accItem.id = 1;
        accItem.idXML = 'Clas_1699352150016172AccOfer_22ElemAcc_2';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ClientePortalCli_item_Clas_1699352150016172AccOfer_22ElemAcc_2',
            'Modificar notas');
        ...
        accItem = new AccNavItem();
        accItem.id = 2;
        accItem.idXML = 'Clas_1699352150016172AccOfer_22ElemAcc_4';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ClientePortalCli_item_Clas_1699352150016172AccOfer_22ElemAcc_4',
            'Previsualizar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
        ...
        accItem = new AccNavItem();
        accItem.id = 3;
        accItem.idXML = 'Clas_1699352150016172AccOfer_22ElemAcc_5';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ClientePortalCli_item_Clas_1699352150016172AccOfer_22ElemAcc_5',
            'Descargar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
