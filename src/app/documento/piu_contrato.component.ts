...
export class DocumentoPIUuContratoComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016172UIPobCl_8';
        this.className = ModelConstants.Documento.name;
        this.iuName = 'PIU_Contrato';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Documento_piu_PIU_Contrato',
            'Documentos');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016172AccOfer_7ElemAcc_2';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Contrato_item_Clas_1699352150016172AccOfer_7ElemAcc_2',
            'Modificar notas');
        ...
        accItem = new AccNavItem();
        accItem.id = 1;
        accItem.idXML = 'Clas_1699352150016172AccOfer_7ElemAcc_4';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Contrato_item_Clas_1699352150016172AccOfer_7ElemAcc_4',
            'Previsualizar');
        accItem.nounVerb = true;
        ...
        accItem = new AccNavItem();
        accItem.id = 2;
        accItem.idXML = 'Clas_1699352150016172AccOfer_7ElemAcc_5';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Contrato_item_Clas_1699352150016172AccOfer_7ElemAcc_5',
            'Descargar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
        ...
        accItem = new AccNavItem();
        accItem.id = 3;
        accItem.idXML = 'Clas_1699352150016172AccOfer_7ElemAcc_8';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Contrato_item_Clas_1699352150016172AccOfer_7ElemAcc_8',
            'Obtener firmado');
        accItem.nounVerb = true;
        accItem.multiSelection = false;
        accItem.agents = [ModelConstants.Cliente.name];
        accItem.targetClass = ModelConstants.Documento.name;
        accItem.targetUI = ModelConstants.Documento.siuutobtenerfirmado4contrato;
        accItem.setShowInModalProperties('genericsiu',
            this.langMng.translateText(
            'cls_Documento_svc_TOBTENERFIRMADO4CONTRATO',
            'Obtener firmado'));
    ...
    public initializeNavigations(): void {
        ...
        navItem.id = 0;
        navItem.idXML = 'Clas_1699352150016172NavOfer_4ElemNav_1';
        navItem.alias = this.langMng.translateText(
            'cls_Documento_nav_N_DocumentoContrato_item_Clas_1699352150016172NavOfer_4ElemNav_1',
