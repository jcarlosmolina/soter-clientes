...
export class DocumentoPIUuContratoPortalCliComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016172UIPobCl_27';
        this.className = ModelConstants.Documento.name;
        this.iuName = 'PIU_ContratoPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Documento_piu_PIU_ContratoPortalCli',
            'Documentos');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016172AccOfer_26ElemAcc_2';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ContratoPortalCli_item_Clas_1699352150016172AccOfer_26ElemAcc_2',
            'Modificar notas');
        ...
        accItem = new AccNavItem();
        accItem.id = 1;
        accItem.idXML = 'Clas_1699352150016172AccOfer_26ElemAcc_4';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ContratoPortalCli_item_Clas_1699352150016172AccOfer_26ElemAcc_4',
            'Previsualizar');
        accItem.nounVerb = true;
        ...
        accItem = new AccNavItem();
        accItem.id = 2;
        accItem.idXML = 'Clas_1699352150016172AccOfer_26ElemAcc_5';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ContratoPortalCli_item_Clas_1699352150016172AccOfer_26ElemAcc_5',
            'Descargar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
        ...
        accItem = new AccNavItem();
        accItem.id = 3;
        accItem.idXML = 'Clas_1699352150016172AccOfer_26ElemAcc_8';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ContratoPortalCli_item_Clas_1699352150016172AccOfer_26ElemAcc_8',
            'Obtener firmado');
        accItem.nounVerb = true;
        accItem.multiSelection = false;
        accItem.agents = [ModelConstants.Cliente.name];
