...
export class DocumentoPIUuCuotaComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016172UIPobCl_9';
        this.className = ModelConstants.Documento.name;
        this.iuName = 'PIU_Cuota';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Documento_piu_PIU_Cuota',
            'Documentos');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016172AccOfer_8ElemAcc_2';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Cuota_item_Clas_1699352150016172AccOfer_8ElemAcc_2',
            'Modificar notas');
        ...
        accItem = new AccNavItem();
        accItem.id = 1;
        accItem.idXML = 'Clas_1699352150016172AccOfer_8ElemAcc_4';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Cuota_item_Clas_1699352150016172AccOfer_8ElemAcc_4',
            'Previsualizar');
        accItem.nounVerb = true;
        ...
        accItem = new AccNavItem();
        accItem.id = 2;
        accItem.idXML = 'Clas_1699352150016172AccOfer_8ElemAcc_5';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_Cuota_item_Clas_1699352150016172AccOfer_8ElemAcc_5',
            'Descargar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
    ...
    public initializeNavigations(): void {
        ...
        navItem.id = 0;
        navItem.idXML = 'Clas_1699352150016172NavOfer_5ElemNav_1';
        navItem.alias = this.langMng.translateText(
            'cls_Documento_nav_N_DocumentoCuota_item_Clas_1699352150016172NavOfer_5ElemNav_1',
