...
export class DocumentoPIUuParteTrabajoComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016172UIPobCl_10';
        this.className = ModelConstants.Documento.name;
        this.iuName = 'PIU_ParteTrabajo';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Documento_piu_PIU_ParteTrabajo',
            'Documentos');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016172AccOfer_9ElemAcc_2';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ParteTrabajo_item_Clas_1699352150016172AccOfer_9ElemAcc_2',
            'Modificar notas');
        ...
        accItem = new AccNavItem();
        accItem.id = 1;
        accItem.idXML = 'Clas_1699352150016172AccOfer_9ElemAcc_3';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ParteTrabajo_item_Clas_1699352150016172AccOfer_9ElemAcc_3',
            'Previsualizar');
        accItem.nounVerb = true;
        ...
        accItem = new AccNavItem();
        accItem.id = 2;
        accItem.idXML = 'Clas_1699352150016172AccOfer_9ElemAcc_4';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ParteTrabajo_item_Clas_1699352150016172AccOfer_9ElemAcc_4',
            'Descargar');
        accItem.nounVerb = true;
        accItem.multiSelection = true;
        accItem.agents = [ModelConstants.Cliente.name];
        ...
        accItem = new AccNavItem();
        accItem.id = 3;
        accItem.idXML = 'Clas_1699352150016172AccOfer_9ElemAcc_7';
        accItem.alias = this.langMng.translateText(
            'cls_Documento_act_A_ParteTrabajo_item_Clas_1699352150016172AccOfer_9ElemAcc_7',
            'Obtener firmado');
        accItem.nounVerb = true;
        accItem.multiSelection = false;
        accItem.agents = [ModelConstants.Cliente.name];
