...
@Component({
    selector: 'imes-documento-siu-abrirnuevaventana',
    templateUrl: './siu_abrirnuevaventana.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DocumentoSIUuabrirNuevaVentanaComponent extends AbstractServiceIU implements OnInit {
    /** Fields */
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016172Ser_12UIServ_1';
        this.className = ModelConstants.Documento.name;
        this.iuName = ModelConstants.Documento.siuuabrirnuevaventana;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.serviceName = 'abrirNuevaVentana';
    ...
    public initializeComponents(): void {
        ...
        this.puthisDocuAdjunto.alias = this.langMng.translateText(
            'cls_Documento_svc_abrirNuevaVentana_inArg_p_thisDocuAdjunto',
            'Documento');
    ...
    */
    ...
    public processOutboundArguments(request: any, response: any): boolean {
        this.util.navigateOutboundArgumentsScenario(this.className, 'siu_abrirnuevaventana_out',
