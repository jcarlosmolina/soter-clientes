...
@Component({
    selector: 'imes-documento-siu-descargar-out',
    templateUrl: './siu_descargar_out.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class DocumentoSIUudescargaruOutComponent  extends AbstractIU implements OnInit {
    ...
    public initialize(): void {
        ...
        this.pOutFichero.alias = this.langMng.translateText(
            'cls_Documento_svc_descargar_outArg_pOutFichero',
            'Fichero');
        ...
        this.pOutNombreFichero.alias = this.langMng.translateText(
            'cls_Documento_svc_descargar_outArg_pOutNombreFichero',
            'Nombre');
    ...
    /**
     * Save a file with the argument information
     */
    public onDownloadpOutFichero(): void {

        this.util.saveFileFromBase64(this.pOutFichero.value, this.pOutNombreFichero.value);
    }
}
