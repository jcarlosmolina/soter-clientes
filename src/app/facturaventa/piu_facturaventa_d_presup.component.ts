...
export class FacturaVentaPIUuFacturaVentauDuPresupComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016050UIPobCl_3';
        this.className = ModelConstants.Facturaventa.name;
        this.iuName = 'PIU_FacturaVenta_D_Presup';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_FacturaVenta_piu_PIU_FacturaVenta_D_Presup',
            'Facturas');
