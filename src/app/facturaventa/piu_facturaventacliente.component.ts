...
import { FacturaVentaFilterFuFacturaVentaCliente} from './filters/facturaventafilterfufacturaventacliente';
...
export class FacturaVentaPIUuFacturaVentaClienteComponent extends AbstractPIU {
    ...
    /** Filters */
    public f0: FacturaVentaFilterFuFacturaVentaCliente;
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016050UIPobCl_2';
        this.className = ModelConstants.Facturaventa.name;
        this.iuName = 'PIU_FacturaVentaCliente';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_FacturaVenta_piu_PIU_FacturaVentaCliente',
            'Facturas');
        this.f0 = new FacturaVentaFilterFuFacturaVentaCliente(this.appGlobalInfo,
