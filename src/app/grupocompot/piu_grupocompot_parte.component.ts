...
export class GrupoCompOTPIUuGrupoCompOTuParteComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016750UIPobCl_1';
        this.className = ModelConstants.Grupocompot.name;
        this.iuName = 'PIU_GrupoCompOT_Parte';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_GrupoCompOT_piu_PIU_GrupoCompOT_Parte',
            'Grupos');
