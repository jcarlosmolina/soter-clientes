...
export class GrupoPresupuestoIIUuGrupoPresupuestoDetalleVerComponent extends AbstractIIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016730UIInst_2';
        this.className = ModelConstants.Grupopresupuesto.name;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_GrupoPresupuesto_iiu_IIU_GrupoPresupuestoDetalleVer',
            'Detalles');
