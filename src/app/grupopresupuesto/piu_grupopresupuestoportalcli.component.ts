...
export class GrupoPresupuestoPIUuGrupoPresupuestoPortalCliComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016730UIPobCl_3';
        this.className = ModelConstants.Grupopresupuesto.name;
        this.iuName = 'PIU_GrupoPresupuestoPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_GrupoPresupuesto_piu_PIU_GrupoPresupuestoPortalCli',
            'Grupos');
