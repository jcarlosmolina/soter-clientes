...
@Component({
    selector: 'imes-instalacion-piu-instalacion',
    templateUrl: './piu_instalacion.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class InstalacionPIUuInstalacionComponent extends AbstractPIU implements OnInit {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016405UIPobCl_1';
        this.className = ModelConstants.Instalacion.name;
        this.iuName = ModelConstants.Instalacion.piuuinstalacion;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Instalacion_piu_PIU_Instalacion',
            'Instalaciones');
