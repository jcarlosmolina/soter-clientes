...
export class LnAlbaranVentaPIUuLnAlbaranVentaPortalCliComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016760UIPobCl_4';
        this.className = ModelConstants.Lnalbaranventa.name;
        this.iuName = 'PIU_LnAlbaranVentaPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_LnAlbaranVenta_piu_PIU_LnAlbaranVentaPortalCli',
            'Líneas');
