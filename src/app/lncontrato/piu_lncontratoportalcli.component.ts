...
export class LnContratoPIUuLnContratoPortalCliComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016954UIPobCl_2';
        this.className = ModelConstants.Lncontrato.name;
        this.iuName = 'PIU_LnContratoPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_LnContrato_piu_PIU_LnContratoPortalCli',
            'Líneas');
