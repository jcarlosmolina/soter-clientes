...
export class LnObjetoCtrIIUuLnObjetoCtruCCTVuPortalCliComponent extends AbstractIIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016018UIInst_4';
        this.className = ModelConstants.Lnobjetoctr.name;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_LnObjetoCtr_iiu_IIU_LnObjetoCtr_CCTV_PortalCli',
            'Datos CCTV');
