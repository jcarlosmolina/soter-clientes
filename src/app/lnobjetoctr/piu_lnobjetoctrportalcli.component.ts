...
export class LnObjetoCtrPIUuLnObjetoCtrPortalCliComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016018UIPobCl_2';
        this.className = ModelConstants.Lnobjetoctr.name;
        this.iuName = 'PIU_LnObjetoCtrPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_LnObjetoCtr_piu_PIU_LnObjetoCtrPortalCli',
            'Objetos');
