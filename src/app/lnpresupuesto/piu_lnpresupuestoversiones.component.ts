...
export class LnPresupuestoPIUuLnPresupuestoVersionesComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016080UIPobCl_2';
        this.className = ModelConstants.Lnpresupuesto.name;
        this.iuName = 'PIU_LnPresupuestoVersiones';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_LnPresupuesto_piu_PIU_LnPresupuestoVersiones',
            'Líneas');
