...
import { OrdenTrabajoFilterFuOrdenTrabajo} from './filters/ordentrabajofilterfuordentrabajo';
...
@Component({
    selector: 'imes-ordentrabajo-piu-ordentrabajo',
    templateUrl: './piu_ordentrabajo.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class OrdenTrabajoPIUuOrdenTrabajoComponent extends AbstractPIU implements OnInit {
    ...
    /** Filters */
    public f0: OrdenTrabajoFilterFuOrdenTrabajo;
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016871UIPobCl_2';
        this.className = ModelConstants.Ordentrabajo.name;
        this.iuName = ModelConstants.Ordentrabajo.piuuordentrabajo;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_OrdenTrabajo_piu_PIU_OrdenTrabajo',
            'Órdenes de trabajo');
        this.f0 = new OrdenTrabajoFilterFuOrdenTrabajo(this.appGlobalInfo,
