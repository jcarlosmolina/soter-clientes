...
export class OrdenTrabajoPIUuOrdenTrabajo4PresupuestoComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016871UIPobCl_6';
        this.className = ModelConstants.Ordentrabajo.name;
        this.iuName = 'PIU_OrdenTrabajo4Presupuesto';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_OrdenTrabajo_piu_PIU_OrdenTrabajo4Presupuesto',
            'Órdenes de trabajo');
    ...
    public initializeDisplaySet(): void {
        ...
        dsItem.idXML = 'Clas_1699352150016871CjtoVis_11ICtjoVis_1';
        dsItem.name = 'id_ordentrabajo';
        dsItem.field = 'id_ordentrabajo';
        dsItem.type = Field.dtAuto;
        dsItem.alias = this.langMng.translateText(
            'cls_OrdenTrabajo_ds_DSP_OrdenTrabajoDetPresup_item_Clas_1699352150016871CjtoVis_11ICtjoVis_1',
        ...
        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016871CjtoVis_11ICtjoVis_3';
        dsItem.name = 'instalacion.nombre';
        dsItem.field = 'instalacion-nombre';
        dsItem.type = Field.dtString;
        dsItem.maxLength = 100;
        dsItem.alias = this.langMng.translateText(
            'cls_OrdenTrabajo_ds_DSP_OrdenTrabajoDetPresup_item_Clas_1699352150016871CjtoVis_11ICtjoVis_3',
            this.dsinstalaciondnombre);
        dsItem.agents = [ModelConstants.Cliente.name];
        this.displaySet.push(dsItem);

        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016871CjtoVis_11ICtjoVis_4';
        dsItem.name = 'estado';
        dsItem.field = 'estado';
        dsItem.type = Field.dtString;
        dsItem.maxLength = 1;
        dsItem.alias = this.langMng.translateText(
            'cls_OrdenTrabajo_ds_DSP_OrdenTrabajoDetPresup_item_Clas_1699352150016871CjtoVis_11ICtjoVis_4',
            this.dsestado);
        dsItem.agents = [ModelConstants.Cliente.name];
        ...
        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016871CjtoVis_11ICtjoVis_5';
        dsItem.name = 'fechaprevista';
        dsItem.field = 'fechaprevista';
        dsItem.type = Field.dtDate;
        dsItem.alias = this.langMng.translateText(
            'cls_OrdenTrabajo_ds_DSP_OrdenTrabajoDetPresup_item_Clas_1699352150016871CjtoVis_11ICtjoVis_5',
            this.dsfechaprevista);
        dsItem.agents = [ModelConstants.Cliente.name];
        this.displaySet.push(dsItem);

        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016871CjtoVis_11ICtjoVis_6';
        dsItem.name = 'tipoorden';
        dsItem.field = 'tipoorden';
        dsItem.type = Field.dtString;
        dsItem.maxLength = 1;
        dsItem.alias = this.langMng.translateText(
            'cls_OrdenTrabajo_ds_DSP_OrdenTrabajoDetPresup_item_Clas_1699352150016871CjtoVis_11ICtjoVis_6',
            this.dstipoorden);
        dsItem.agents = [ModelConstants.Cliente.name];
