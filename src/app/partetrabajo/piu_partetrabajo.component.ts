...
@Component({
    selector: 'imes-partetrabajo-piu-partetrabajo',
    templateUrl: './piu_partetrabajo.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class ParteTrabajoPIUuParteTrabajoComponent extends AbstractPIU implements OnInit {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016581UIPobCl_1';
        this.className = ModelConstants.Partetrabajo.name;
        this.iuName = ModelConstants.Partetrabajo.piuupartetrabajo;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_ParteTrabajo_piu_PIU_ParteTrabajo',
            'Partes de trabajo');
