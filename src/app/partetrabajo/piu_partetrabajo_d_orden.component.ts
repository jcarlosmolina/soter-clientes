...
export class ParteTrabajoPIUuParteTrabajouDuOrdenComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016581UIPobCl_4';
        this.className = ModelConstants.Partetrabajo.name;
        this.iuName = 'PIU_ParteTrabajo_D_Orden';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_ParteTrabajo_piu_PIU_ParteTrabajo_D_Orden',
            'Partes de trabajo');
