...
export class PresupuestoIIUuPresupuestoDatosContablesComponent extends AbstractIIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016913UIInst_4';
        this.className = ModelConstants.Presupuesto.name;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Presupuesto_iiu_IIU_PresupuestoDatosContables',
            'Datos contables');
    ...
    public initializeDisplaySet(): void {
        ...
        this.dseCuentaContable.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_1',
            'Cuenta contable');
        this.dseCuentaContable.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_1', ['Cliente']);
        ...
        this.dseAplicaRecargoEquivalencia.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_2',
        ...
        this.dseAplicaRecargoEquivalencia.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_2', ['Cliente']);
        ...
        this.dseEntidadBancariaNombre.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_3',
            'Entidad');
        this.dseEntidadBancariaNombre.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_3', ['Cliente']);
        ...
        this.dseSucursalBancariaNombre.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_4',
            'Sucursal');
        this.dseSucursalBancariaNombre.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_4', ['Cliente']);
        ...
        this.dseDCCuentaBancaria.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_5',
            'DC');
        this.dseDCCuentaBancaria.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_5', ['Cliente']);
        ...
        this.dseCuentaBancaria.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_6',
            'Cuenta');
        this.dseCuentaBancaria.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_6', ['Cliente']);
        ...
        this.dseIBANCuentaBancaria.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_7',
            'IBAN');
        this.dseIBANCuentaBancaria.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_7', ['Cliente']);
        ...
        this.dseSwift.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_8',
            'Swift');
        this.dseSwift.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_8', ['Cliente']);
        ...
        this.dseFormaPagoDescripcion.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_9',
            'Forma de pago');
        this.dseFormaPagoDescripcion.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_9', ['Cliente']);
        ...
        this.dsePeriodicidadPagoNombre.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_10',
            'Periodicidad de pago');
        this.dsePeriodicidadPagoNombre.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_10', ['Cliente']);
        ...
        this.dsePorcentajeRetencion.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSI_PresupuestoDatosContables_item_Clas_1699352150016913CjtoVis_6ICtjoVis_11',
            '% Retención');
        this.dsePorcentajeRetencion.visible = this.appGlobalInfo.getLoggedUserInfo().isAttributeVisible(this.idXML,
            'Clas_1699352150016913CjtoVis_6ICtjoVis_11', ['Cliente']);
