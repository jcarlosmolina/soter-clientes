...
export class PresupuestoPIUuPresupuestoComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016913UIPobCl_1';
        this.className = ModelConstants.Presupuesto.name;
        this.iuName = 'PIU_Presupuesto';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Presupuesto_piu_PIU_Presupuesto',
            'Presupuestos');
    ...
    public initializeDisplaySet(): void {
        ...
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_1';
        dsItem.name = 'codigo';
        dsItem.field = 'codigo';
        dsItem.type = Field.dtString;
        dsItem.maxLength = 10;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_1',
            this.dscodigo);
        ...
        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_2';
        dsItem.name = 'cliente.nombrerazonsocial';
        dsItem.field = 'cliente-nombrerazonsocial';
        dsItem.type = Field.dtString;
        dsItem.maxLength = 300;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_2',
            this.dsclientednombrerazonsocial);
        dsItem.agents = [ModelConstants.Cliente.name];
        this.displaySet.push(dsItem);

        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_3';
        dsItem.name = 'fecha';
        dsItem.field = 'fecha';
        dsItem.type = Field.dtDate;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_3',
            this.dsfecha);
        dsItem.agents = [ModelConstants.Cliente.name];
        this.displaySet.push(dsItem);

        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_4';
        dsItem.name = 'tipossistema';
        dsItem.field = 'tipossistema';
        dsItem.type = Field.dtString;
        dsItem.maxLength = 300;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_4',
            this.dstipossistema);
        dsItem.agents = [ModelConstants.Cliente.name];
        this.displaySet.push(dsItem);

        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_5';
        dsItem.name = 'estado';
        dsItem.field = 'estado';
        dsItem.type = Field.dtString;
        dsItem.maxLength = 10;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_5',
            this.dsestado);
        dsItem.agents = [ModelConstants.Cliente.name];
        ...
        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_6';
        dsItem.name = 'fechaaceptacion';
        dsItem.field = 'fechaaceptacion';
        dsItem.type = Field.dtDate;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_6',
            this.dsfechaaceptacion);
        dsItem.agents = [ModelConstants.Cliente.name];
        this.displaySet.push(dsItem);

        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_7';
        dsItem.name = 'fecharechazo';
        dsItem.field = 'fecharechazo';
        dsItem.type = Field.dtDate;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_7',
            this.dsfecharechazo);
        dsItem.agents = [ModelConstants.Cliente.name];
        this.displaySet.push(dsItem);

        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_8';
        dsItem.name = 'fechaanulacion';
        dsItem.field = 'fechaanulacion';
        dsItem.type = Field.dtDate;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_8',
            this.dsfechaanulacion);
        dsItem.agents = [ModelConstants.Cliente.name];
        this.displaySet.push(dsItem);

        dsItem = new DisplaySetItem();
        dsItem.idXML = 'Clas_1699352150016913CjtoVis_1ICtjoVis_9';
        dsItem.name = 'usuariocreacion.nombrecompleto';
        dsItem.field = 'usuariocreacion-nombrecompleto';
        dsItem.type = Field.dtString;
        dsItem.maxLength = 200;
        dsItem.alias = this.langMng.translateText(
            'cls_Presupuesto_ds_DSP_Presupuesto_item_Clas_1699352150016913CjtoVis_1ICtjoVis_9',
