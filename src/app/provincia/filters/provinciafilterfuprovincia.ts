...
/**
 * Manages the filter F_Provincia of class Provincia
 */
export class ProvinciaFilterFuProvincia extends AbstractFilter {
    ...
    constructor(public appGlobalInfo: AppGlobalInfo,
        ...
        this.title = this.langMng.translateText('cls_Provincia_filter_F_Provincia',
            'Buscar');
        this.filterName = 'F_Provincia';
    }
    ...
    public initializeComponents(): void {
        ...
        this.vfNombre.alias = this.langMng.translateText(
            'cls_Provincia_filter_F_Provincia_fvar_vfNombre',
            'Nombre');
