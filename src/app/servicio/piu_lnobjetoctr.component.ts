...
export class ServicioPIUuLnObjetoCtrComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016551UIPobCl_2';
        this.className = ModelConstants.Servicio.name;
        this.iuName = 'PIU_LnObjetoCtr';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Servicio_piu_PIU_LnObjetoCtr',
            'Servicios');
