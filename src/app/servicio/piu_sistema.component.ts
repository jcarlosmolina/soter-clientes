...
export class ServicioPIUuSistemaComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016551UIPobCl_1';
        this.className = ModelConstants.Servicio.name;
        this.iuName = 'PIU_Sistema';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Servicio_piu_PIU_Sistema',
            'Servicios');
