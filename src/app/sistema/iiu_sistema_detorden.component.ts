...
export class SistemaIIUuSistemauDetOrdenComponent extends AbstractIIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016718UIInst_4';
        this.className = ModelConstants.Sistema.name;
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Sistema_iiu_IIU_Sistema_DetOrden',
            'Sistema');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016718AccOfer_4ElemAcc_1';
        accItem.alias = this.langMng.translateText(
            'cls_Sistema_act_AIIU_Sistema_DetOrden_item_Clas_1699352150016718AccOfer_4ElemAcc_1',
            'Detalles');
        ...
        accItem.targetUI = ModelConstants.Sistema.mdiuusistema;
