...
export class SistemaPIUuSistemaContratoComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016718UIPobCl_2';
        this.className = ModelConstants.Sistema.name;
        this.iuName = 'PIU_SistemaContrato';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Sistema_piu_PIU_SistemaContrato',
            'Sistemas');
