...
export class SistemaPIUuSistemaPortalCliComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016718UIPobCl_3';
        this.className = ModelConstants.Sistema.name;
        this.iuName = 'PIU_SistemaPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Sistema_piu_PIU_SistemaPortalCli',
            'Sistemas');
    ...
    public initializeActions(): void {
        ...
        accItem.id = 0;
        accItem.idXML = 'Clas_1699352150016718AccOfer_5ElemAcc_6';
        accItem.alias = this.langMng.translateText(
            'cls_Sistema_act_APIU_SistemaPortalCli_item_Clas_1699352150016718AccOfer_5ElemAcc_6',
            'Tal como se instaló');
