...
@Component({
    selector: 'imes-sistema-siu-timprimir-out',
    templateUrl: './siu_timprimir_out.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class SistemaSIUuTIMPRIMIRuOutComponent  extends AbstractIU implements OnInit {
    ...
    public initialize(): void {
        ...
        this.pOutFichero.alias = this.langMng.translateText(
            'cls_Sistema_svc_TIMPRIMIR_outArg_pOutFichero',
            'Fichero');
        ...
        this.pOutNombreFichero.alias = this.langMng.translateText(
            'cls_Sistema_svc_TIMPRIMIR_outArg_pOutNombreFichero',
            'Nombre');
