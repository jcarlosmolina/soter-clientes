...
/**
 * Service and queries of class 'SubTotalFacturaVenta'
 */
export class SubTotalFacturaVentaServices extends AbstractServices {


    constructor(
        protected readonly appGlobalInfo: AppGlobalInfo,
        protected readonly util: Util) {
        super(appGlobalInfo, util, 'SubTotalFacturaVenta');
    }
