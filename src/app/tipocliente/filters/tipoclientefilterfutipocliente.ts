...
/**
 * Manages the filter F_TipoCliente of class TipoCliente
 */
export class TipoClienteFilterFuTipoCliente extends AbstractFilter {
    ...
    constructor(public appGlobalInfo: AppGlobalInfo,
        ...
        this.title = this.langMng.translateText('cls_TipoCliente_filter_F_TipoCliente',
            'Buscar');
        this.filterName = 'F_TipoCliente';
    }
    ...
    public initializeComponents(): void {
        ...
        this.vfDesc.alias = this.langMng.translateText(
            'cls_TipoCliente_filter_F_TipoCliente_fvar_vfDesc',
            'Descripción');
