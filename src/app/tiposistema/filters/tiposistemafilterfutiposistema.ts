...
/**
 * Manages the filter F_TipoSistema of class TipoSistema
 */
export class TipoSistemaFilterFuTipoSistema extends AbstractFilter {
    ...
    constructor(public appGlobalInfo: AppGlobalInfo,
        ...
        this.title = this.langMng.translateText('cls_TipoSistema_filter_F_TipoSistema',
            'Buscar');
        this.filterName = 'F_TipoSistema';
    }
    ...
    public initializeComponents(): void {
        ...
        this.vfDesc.alias = this.langMng.translateText(
            'cls_TipoSistema_filter_F_TipoSistema_fvar_vfDesc',
            'Descripción');
