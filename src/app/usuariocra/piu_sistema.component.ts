...
export class UsuarioCRAPIUuSistemaComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016373UIPobCl_1';
        this.className = ModelConstants.Usuariocra.name;
        this.iuName = 'PIU_Sistema';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_UsuarioCRA_piu_PIU_Sistema',
            'Usuarios CRA');
