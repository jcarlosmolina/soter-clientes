...
export class UsuarioCRAPIUuUsuarioCRAPortalCliComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016373UIPobCl_4';
        this.className = ModelConstants.Usuariocra.name;
        this.iuName = 'PIU_UsuarioCRAPortalCli';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_UsuarioCRA_piu_PIU_UsuarioCRAPortalCli',
            'Usuarios CRA');
