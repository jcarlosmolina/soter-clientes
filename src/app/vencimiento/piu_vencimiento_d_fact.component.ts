...
export class VencimientoPIUuVencimientouDuFactComponent extends AbstractPIU {
    ...
    constructor(
        ...
        this.idXML = 'Clas_1699352150016137UIPobCl_1';
        this.className = ModelConstants.Vencimiento.name;
        this.iuName = 'PIU_Vencimiento_D_Fact';
        this.setUserVisibility(this.appGlobalInfo.getLoggedUserInfo().isIUVisible(this.idXML, ['Cliente']));
        this.title = this.langMng.translateText('cls_Vencimiento_piu_PIU_Vencimiento_D_Fact',
            'Vencimientos');
